...
class FootstepAnnotator:
    def __init__(self, video_path):
        ...
        print("  L        - Mark LEFT foot step")
        print("  R        - Mark RIGHT foot step") 
    ...
    def show_help(self):
        ...
        print()
        print("ANNOTATION:")
        print("  L        - Mark LEFT foot touching ground")
        print("  R        - Mark RIGHT foot touching ground")
        print("  U        - Undo last annotation")
        print()
        print("FILE:")
    ...
    def draw_annotations_overlay(self, frame):
        ...
        # Controls reminder
        controls = "L=Left step | R=Right step | SPACE=Play/Pause | A/D=Frame step | S=Save | Q=Quit | H=Help"
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                elif key == ord('l'):  # L - left foot
                    self.add_annotation('left')
                
                elif key == ord('r'):  # R - right foot
